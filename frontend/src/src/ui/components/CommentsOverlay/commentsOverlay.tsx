...
import DialogCard from "@/ui/components/DialogCard/dialogCard";
...
import DeleteAlbumDialog from "@/ui/components/DialogCard/deleteAlbum";
import * as Modal from "@/ui/components/Modal/modal";
import Toast from "@/ui/components/Toast/toast";
import type { Album } from "@/ui/types/album";
import CreateAlbumDialog from "@/ui/components/DialogCard/createAlbum";
import type { PostBody } from "@/ui/types/post";
import type { KeyboardEvent, MouseEvent, ChangeEvent, InputEvent } from "react";
import {
    type Comment as CommentInterface,
    CommentMetrics,
} from "@/ui/types/comment";
import {
...
import type {
    CommentObject,
    CommentUserData,
} from "@/ui/components/Comment/types";
...
export default function CommentsOverlay({
    ...
    const handleCommentCreation = async (
        ...
        if (success) {
            ...
            Toast(`Error: Could not make the comment`);
        }
