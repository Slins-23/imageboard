...
import UserPlaceholder from "@/ui/components/UserPlaceholder/userPlaceholder";
import Image from "next/image";
import Toast from "../Toast/toast";
import { CommentLike } from "@/ui/types/like";
import placeholderStyle from "@/ui/components/UserPlaceholder/userPlaceholder.module.css";
...
function defaultOnLiked() {
    Toast("Successfully liked comment server-side");
}
